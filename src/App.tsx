...
import { LayoutGrid, List, Calendar, Trash2, CheckSquare, Square } from 'lucide-react';
      ...
      <header className="bg-white border-b border-slate-200 px-6 py-5">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-start justify-between">
            <div>
              <h1 className="text-2xl font-semibold text-slate-900 tracking-tight">Uma Musume Planner</h1>
              <p className="text-sm text-slate-500 mt-1">Schedule races to maximize epithets across 60 turns</p>
            </div>
            
            <div className="flex items-center gap-6">
              <div className="text-right">
                <div className="text-2xl font-semibold text-slate-900">{selectedRaces.length}</div>
              ...
              {consecutiveTurns.length > 0 && (
                <div className="px-3 py-2 bg-amber-50 border border-amber-200 rounded-md">
                  <div className="text-sm font-medium text-amber-700">{consecutiveTurns.length}</div>
